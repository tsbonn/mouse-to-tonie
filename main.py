...
try:
    ...
    print(f"Error on reading config file config.ini: {e}")
    exit(1)
    ...
    if downloaded_file is not None:
        try:
            ...
            if selected_tonie:
                ...
                print(f"No CreativeTonie found with the name '{creative_tonie_name}'")
        except Exception as e:
            print(f"Error during Tonie API operations: {e}")
